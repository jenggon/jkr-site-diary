...
INSERT INTO auth.identities (
    ...
    '99999999-9999-4999-8999-999999999991',
    '99999999-9999-4999-8999-999999999991',
    '{"sub":"99999999-9999-4999-8999-999999999991","email":"submitter@jkr.gov.my"}',
    'email', now(), now(), now()
...
INSERT INTO auth.identities (
    ...
    '99999999-9999-4999-8999-999999999992',
    '99999999-9999-4999-8999-999999999992',
    '{"sub":"99999999-9999-4999-8999-999999999992","email":"reviewer@jkr.gov.my"}',
    'email', now(), now(), now()
) ON CONFLICT DO NOTHING;
...
INSERT INTO auth.identities (
    ...
    '99999999-9999-4999-8999-999999999993',
    '99999999-9999-4999-8999-999999999993',
    '{"sub":"99999999-9999-4999-8999-999999999993","email":"unauthorized@external.com"}',
    'email', now(), now(), now()
) ON CONFLICT DO NOTHING;
...
INSERT INTO public.user_profile (user_id, full_name, is_active) VALUES
    ('99999999-9999-4999-8999-999999999991', 'C01 Submitter', true),
    ('99999999-9999-4999-8999-999999999992', 'C01 Reviewer',  true),
    ('99999999-9999-4999-8999-999999999993', 'C01 Unauth',    true),
...
UPDATE public.programme
    SET current_revision_id = '77777777-7777-4777-8777-777777777777'
    WHERE programme_id = '11111111-1111-4111-8111-111111111111';

UPDATE public.programme
    SET current_revision_id = '44444444-4444-4444-8444-444444444444'
    WHERE programme_id = '22222222-2222-4222-8222-222222222222';
...
BEGIN
    ...
    VALUES (gen_random_uuid(), '11111111-1111-4111-8111-111111111111', '99999999-9999-4999-8999-999999999991', v_ss_id, true, now())
    ON CONFLICT DO NOTHING;

    -- P2 = RESIDENT_ENGINEER in Programme A
    INSERT INTO public.programme_membership (membership_id, programme_id, user_id, role_id, is_active, created_at)
    VALUES (gen_random_uuid(), '11111111-1111-4111-8111-111111111111', '99999999-9999-4999-8999-999999999992', v_re_id, true, now())
    ON CONFLICT DO NOTHING;
    -- P1 = SITE_SUPERVISOR in Programme B
    INSERT INTO public.programme_membership (membership_id, programme_id, user_id, role_id, is_active, created_at)
    VALUES (gen_random_uuid(), '22222222-2222-4222-8222-222222222222', '99999999-9999-4999-8999-999999999991', v_ss_id, true, now())
    ON CONFLICT DO NOTHING;

    -- P3 = inactive membership in Programme B (must grant no discovery)
    INSERT INTO public.programme_membership (membership_id, programme_id, user_id, role_id, is_active, created_at)
    VALUES ('c0400000-0000-4000-8000-000000000103', '22222222-2222-4222-8222-222222222222', '99999999-9999-4999-8999-999999999993', v_re_id, false, now())
...
INSERT INTO public.task (
    ...
    '2026-08-01T00:00:00.000Z', '99999999-9999-4999-8999-999999999991'
) ON CONFLICT DO NOTHING;
...
INSERT INTO public.task (
    ...
    ('b02b1000-0000-4000-8000-000000000001', '11111111-1111-4111-8111-111111111111', '33333333-3333-4333-8333-333333333333', 'Pemasangan tetulang rasuk utama Blok Pentadbiran', 27001, 'B02B.SINGLE.PAGE.001.LONG-WBS', '8.1', true, now(), '99999999-9999-4999-8999-999999999991'),
    ('b02b1000-0000-4000-8000-000000000002', '11111111-1111-4111-8111-111111111111', '33333333-3333-4333-8333-333333333333', 'Penuangan konkrit papak podium dan pemeriksaan kemasan permukaan', 27002, 'B02B.OVERFLOW.002.LONG-WBS', '8.2', false, now(), '99999999-9999-4999-8999-999999999991'),
    ('b02b1000-0000-4000-8000-000000000003', '11111111-1111-4111-8111-111111111111', '77777777-7777-4777-8777-777777777777', 'Kerja konkrit aras sejarah untuk pengesahan cetakan tepat', 27003, 'B02B.HISTORICAL.EXACT.003', '7.3', false, '2026-08-02T00:00:00.000Z', '99999999-9999-4999-8999-999999999991'),
    ('b02b1000-0000-4000-8000-000000000004', '22222222-2222-4222-8222-222222222222', '44444444-4444-4444-8444-444444444444', 'Rekod asing Program B untuk bukti tidak boleh disenaraikan', 27004, 'B02B.FOREIGN.004', '9.1', false, now(), '99999999-9999-4999-8999-999999999991')
ON CONFLICT DO NOTHING;
...
INSERT INTO public.activity (
    ...
    'Completed', 'Historical C01 fixture', '99999999-9999-4999-8999-999999999991',
...
INSERT INTO public.activity (
    ...
    'b02b2000-0000-4000-8000-000000000003', '11111111-1111-4111-8111-111111111111',
    '77777777-7777-4777-8777-777777777777', 'b02b1000-0000-4000-8000-000000000003',
    ...
    '99999999-9999-4999-8999-999999999991', '2026-08-02T00:00:00.000Z', '2026-08-02T00:00:00.000Z'
) ON CONFLICT DO NOTHING;
...
INSERT INTO public.site_diary (
    ...
    'b02b3000-0000-4000-8000-000000000003', '11111111-1111-4111-8111-111111111111',
    '77777777-7777-4777-8777-777777777777', 'b02b2000-0000-4000-8000-000000000003',
    ...
    '99999999-9999-4999-8999-999999999991', '2026-08-02T12:00:00.000Z', '2026-08-02T12:00:00.000Z'
) ON CONFLICT DO NOTHING;
...
UPDATE public.programme
    SET current_revision_id = '33333333-3333-4333-8333-333333333333'
    WHERE programme_id = '11111111-1111-4111-8111-111111111111';
UPDATE public.programme_revision
    SET status = 'Superseded'
    WHERE revision_id = '77777777-7777-4777-8777-777777777777';
...
INSERT INTO public.activity (
    ...
    'In Progress', 'Current C01 fixture', '99999999-9999-4999-8999-999999999991',
    now(), now()
) ON CONFLICT DO NOTHING;
...
INSERT INTO public.activity (
    ...
    ('b02b2000-0000-4000-8000-000000000001', '11111111-1111-4111-8111-111111111111', '33333333-3333-4333-8333-333333333333', 'b02b1000-0000-4000-8000-000000000001', 'MSP', 'Single page reinforcement activity', 'Single page reinforcement activity', '2026-08-22', 'New', 'B02-B current single-page activity', '99999999-9999-4999-8999-999999999991', now(), now()),
    ('b02b2000-0000-4000-8000-000000000002', '11111111-1111-4111-8111-111111111111', '33333333-3333-4333-8333-333333333333', 'b02b1000-0000-4000-8000-000000000002', 'MSP', 'Overflow concrete activity', 'Overflow concrete activity', '2026-08-23', 'In Progress', 'B02-B current overflow activity', '99999999-9999-4999-8999-999999999991', now(), now()),
    ('b02b2000-0000-4000-8000-000000000004', '22222222-2222-4222-8222-222222222222', '44444444-4444-4444-8444-444444444444', 'b02b1000-0000-4000-8000-000000000004', 'MSP', 'Foreign Programme B activity', 'Foreign Programme B activity', '2026-08-22', 'Completed', 'B02-B foreign record activity', '99999999-9999-4999-8999-999999999991', now(), now())
ON CONFLICT DO NOTHING;
...
INSERT INTO public.activity (
    ...
    'In Progress', 'Cross-programme C01 fixture', '99999999-9999-4999-8999-999999999991',
    now(), now()
) ON CONFLICT DO NOTHING;
...
INSERT INTO public.site_diary (
    ...
    ('b02b3000-0000-4000-8000-000000000001', '11111111-1111-4111-8111-111111111111', '33333333-3333-4333-8333-333333333333', 'b02b2000-0000-4000-8000-000000000001', '2026-08-22', 'New', 'Pemeriksaan tetulang selesai; ruang kerja selamat dan teratur.', '{"location":"Aras 2, Zon Timur, Blok Pentadbiran Utama","work_start_time":"08:15","work_end_time":"17:05","weather_condition":"HUJAN","rain_start_time":"10:30","rain_end_time":"11:45","contractor_scope":"NSC"}'::jsonb, '[{"trade_name":"Tukang Besi NSC","bumi_count":3,"non_bumi_count":1,"foreign_count":0},{"trade_name":"Penyelia Keselamatan NSC","bumi_count":1,"non_bumi_count":0,"foreign_count":0}]'::jsonb, '99999999-9999-4999-8999-999999999991', '2026-08-22T18:00:00.000Z', '2026-08-22T18:00:00.000Z'),
    ('b02b3000-0000-4000-8000-000000000002', '11111111-1111-4111-8111-111111111111', '33333333-3333-4333-8333-333333333333', 'b02b2000-0000-4000-8000-000000000002', '2026-08-23', 'In Progress', 'Penuangan berperingkat diteruskan mengikut kaedah kerja diluluskan; pemeriksaan mutu setiap zon direkodkan.', '{"location":"Podium Utama, Grid A1 hingga H8, Laluan Logistik Timur","work_start_time":"07:00","work_end_time":"19:15","weather_condition":"ELOK","rain_start_time":null,"rain_end_time":null,"contractor_scope":"CONTRACTOR"}'::jsonb, '[{"trade_name":"Jurutera Tapak Kontraktor Utama","bumi_count":1,"non_bumi_count":0,"foreign_count":0},{"trade_name":"Penyelia Penuangan Konkrit","bumi_count":2,"non_bumi_count":0,"foreign_count":0},{"trade_name":"Tukang Konkrit Kemasan Permukaan","bumi_count":4,"non_bumi_count":1,"foreign_count":2},{"trade_name":"Tukang Besi Tetulang Podium","bumi_count":5,"non_bumi_count":0,"foreign_count":1},{"trade_name":"Tukang Kayu Acuan Papak","bumi_count":4,"non_bumi_count":1,"foreign_count":2},{"trade_name":"Operator Pam Konkrit Bergerak","bumi_count":1,"non_bumi_count":0,"foreign_count":1},{"trade_name":"Pemandu Lori Bancuhan Konkrit","bumi_count":2,"non_bumi_count":0,"foreign_count":3},{"trade_name":"Pegawai Keselamatan dan Kesihatan","bumi_count":1,"non_bumi_count":0,"foreign_count":0},{"trade_name":"Juruukur Aras dan Penjajaran","bumi_count":2,"non_bumi_count":1,"foreign_count":0},{"trade_name":"Pekerja Am Pembersihan Tapak","bumi_count":3,"non_bumi_count":1,"foreign_count":2}]'::jsonb, '99999999-9999-4999-8999-999999999991', '2026-08-23T20:00:00.000Z', '2026-08-23T20:00:00.000Z'),
    ('b02b3000-0000-4000-8000-000000000004', '22222222-2222-4222-8222-222222222222', '44444444-4444-4444-8444-444444444444', 'b02b2000-0000-4000-8000-000000000004', '2026-08-22', 'Completed', 'B02-B foreign Programme B record.', '{"location":"Program B","work_start_time":"08:00","work_end_time":"17:00","weather_condition":"ELOK","rain_start_time":null,"rain_end_time":null,"contractor_scope":"CONTRACTOR"}'::jsonb, '[]'::jsonb, '99999999-9999-4999-8999-999999999991', '2026-08-22T18:00:00.000Z', '2026-08-22T18:00:00.000Z')
ON CONFLICT DO NOTHING;
