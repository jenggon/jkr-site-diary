...
async function runLiveTests() {
    ...
    const p1Approve = await clientP1.rpc('a27_update_approval_atomic', {
        p_approval_id: '66666666-6666-4666-8666-666666666661',
        p_payload: { approval_status: 'Approved', approval_comment: 'I am subverting' },
        p_actor_id: '99999999-9999-4999-8999-999999999991',
        p_audit_id: '10000000-0000-4000-8000-000000000000',
    ...
    const p2ApproveStale = await clientP2.rpc('a27_update_approval_atomic', {
        ...
        p_audit_id: '20000000-0000-4000-8000-000000000000',
    ...
    const p1Queue = await clientP1.rpc('f24_get_site_diary_approval_queue', { p_programme_id: '11111111-1111-4111-8111-111111111111' });
    ...
    const p2Queue = await clientP2.rpc('f24_get_site_diary_approval_queue', { p_programme_id: '11111111-1111-4111-8111-111111111111' });
    ...
    const p1Review = await clientP1.rpc('f24_get_site_diary_approval_review', { p_approval_id: '66666666-6666-4666-8666-666666666661' });
    ...
    const p2Review = await clientP2.rpc('f24_get_site_diary_approval_review', { p_approval_id: '66666666-6666-4666-8666-666666666661' });
    ...
    const p3Print = await clientP3.rpc('f25_get_site_diary_print_read', { p_site_diary_id: '55555555-5555-4555-8555-555555555551' });
    ...
    const p1Print = await clientP1.rpc('f25_get_site_diary_print_read', { p_site_diary_id: '55555555-5555-4555-8555-555555555551' });
    ...
    const p1HistPrint = await clientP1.rpc('f25_get_site_diary_print_read', { p_site_diary_id: '55555555-5555-4555-8555-555555555553' });
    ...
    assert.strictEqual(histData.revision_id, '77777777-7777-4777-8777-777777777777', 'Must preserve historical revision ID');
