...
7. Identify the active programme/stage when present.
8. Identify the requirement IDs affected by the requested work.
9. Identify all requirement IDs and no-change boundaries that must remain untouched.
...
Reports MUST evaluate implementation against the lockset and active programme roadmap, not the reverse. Findings must name the affected requirement IDs.
...
9. physical acceptance status where required;
10. explicit disclosure of any remaining red or unverified gate.
